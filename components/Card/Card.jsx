  ...
  return (
    ...
    >
      ...
      >
        ...
        {!isOpen && (
          <button
            className="absolute top-0 right-0 bottom-0 left-0 z-20 rounded-3xl hover:ring focus:ring ring-palette-yellow ring-offset-8 focus:outline-none transition"
            onClick={(e) => {
              e.stopPropagation();
              openCard();
            }}
