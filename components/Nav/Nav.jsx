...
function ToggleButton({ onClick, isOpen }) {
  return (
    <button
      onClick={onClick}
      className="absolute right-0 top-7 flex justify-center items-center border border-neutral-200 dark:border-slate-700 bg-neutral-100 dark:bg-slate-900 p-4 rounded-full focus:outline-none z-50 focus:ring ring-palette-yellow ring-offset-4 ring-offset-neutral-50 dark:ring-offset-slate-800 transition"
    >
